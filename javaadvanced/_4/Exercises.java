package javabasics.javaadvanced._4;
...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        try(FileWriter writer = new FileWriter(MY_PATH.toFile())) {
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4: ");
        try {
            System.out.println(Arrays.stream(Files.readString(Path.of("C:\\Users\\Giuseppe Francy\\Desktop\\esercizi\\file.txt")).split(" ")).count());
            // Your code here
        } catch (Exception exception) {
            System.err.println("There was an error!");
            exception.printStackTrace();
    ...
    private static void exercise5() {
        ...
        try {Files.createDirectories(myDirectoryPath);
            // Your code
