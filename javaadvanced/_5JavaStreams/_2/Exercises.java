package javabasics.javaadvanced._5JavaStreams._2;
...
public class Exercises {
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2: ");
        Set<Integer>ourNumberButOnlyOdd = ourNumbers.stream().filter(s -> s%2 != 0).collect(Collectors.toSet());
        System.out.println(ourNumberButOnlyOdd);
        // Your code here
    }
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4");
        Set<Integer> x = ourNumbers.stream().filter(s-> s %2 ==0).map(s -> s*2).collect(Collectors.toSet());
