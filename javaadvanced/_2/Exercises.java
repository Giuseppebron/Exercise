package javabasics.javaadvanced._2;
...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(1, "Napoli");
        myFirstMap.put(2, "Lazio");
        myFirstMap.put(3, "Juventus");
    ...
    private static void exercise2() {
        ...
        // Your code
        double value = 0.00;
        for (Map.Entry<String,Double> menu :menuCostsInEuro.entrySet()) {
            menu.getKey();
            menu.getValue();
            System.out.println(menu.getValue());
            if (mostExpensiveMenuItemName == null){
                mostExpensiveMenuItemName = menu.getKey();
