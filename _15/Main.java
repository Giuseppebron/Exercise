...
public class Main {
     ...
     * A1:while
     *because for us it is easy write in 'case' withdraw to do this...for every specific case
     * Q2: We have a list of 1000 users to send emails to
     * A2:for each
     *we can loop an array, fastest.
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3:fori
     *because we know how many customers we have so we can write a specific condition with 'i' (for example)
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4:dowhile
     * with do while we can run code and just later will apply the while condition
     */
}
