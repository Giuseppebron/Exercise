...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // stampera' il numero intero piu piccolo possibile ma che sara' comunque >= al valore inserito (ourValue)
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        // stampera' il numero intero piu grande possibile ma che sara' comunque <= al valore inserito (ourValue)
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue));
        // stampera' il numero intero piu vicino al valore inserito (ourValue)
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // il risultato che stampera' sara' il primo valore in inserito elevato al secondo valore inserito (ourValue)
        ...
        // stampera' un numero casuale tra 0 e il valore da noi inserito (ourValue)
