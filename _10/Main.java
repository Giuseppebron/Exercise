...
public class Main {
    ...
    private static void exercise2() {
        ...
        //ho inserito > 18 perche e' quello che chiede l'esercizio ma nellarealta' dovrebbe essere >=,
        //per di piu non mi viene chiesto di utilizzare il primitivo euroForEntry
        if (age > 18 && shoeType == "fancy" && eurosInPocket < 10){
