...
public class Main {
    ...
    private static void exercise1() {
        ...
        int ourNumber = Integer.valueOf(ourNumberStr) +2;
        String ourNumberStrPlus2 = String.valueOf(ourNumber);
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "0.25"; // Also this line
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5 ";
        int startStrNum = Integer.valueOf(startStr.trim()) *2;
        String middleStr = String.valueOf(startStrNum)+ String.valueOf(startStrNum);
        double middleStrDbl = Double.valueOf(middleStr) / 3.5;
        double finalDbl     = Math.floor(middleStrDbl);
