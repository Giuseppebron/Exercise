...
public class Main {
    ...
    private static void exercise1() {
        ...
        long myBankBalanceImRich = myBankBalanceEuro + questionableFundsEuro;
        System.out.println(myBankBalanceImRich);
     ...
     *
     *    2a: byte, because people don't live usually more of 127 years.
     *    2b: short, same before.
     *    2c: long, somebody can have a lot of money.
     *    2d: float, we don't need of 16 decimal.
     *    2e: double, we need to take very accurate weight.
     *    2f: int, in the world there is not a place that have a distance biggest of 2,147,438,647 kilometer.
     */
    ...
    public static void exercise3() {
        ...
        System.out.println(LocalDate.now().getDayOfMonth() + " of " + LocalDate.now().getMonth()+
                " i will need money but it is " + LocalDate.now().isBefore(LocalDate.of(2023, Month.valueOf("MAY"),27))
                + " that i take salary " + LocalDate.of(2023, 5,1) + " i don't know how to do." );
